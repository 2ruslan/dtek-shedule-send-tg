...
var token = Environment.GetEnvironmentVariable("TOKEN") ?? "7222841719:AAGGjj1HryvlkGwUzc8EN0baItIYjy4xiyg";
...
async Task OnUpdate(Update update)
{
   ...
   //     case { ChatMemberLeft: { } memberLeft }: await OnMemeberLeft(memberLeft);break;
        default: Console.WriteLine($"Received unhandled update {update.Type}"); break;
    };
}

async Task OnMemeberLeft(ChatMemberLeft memberLeft)
{
